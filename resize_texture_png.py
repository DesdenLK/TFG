...
input_path = r"PathDrawing\Tavascan_934-2864\flow.png"  # Ruta de la textura original
output_path = r"PathDrawing\Tavascan_934-2864\flow_cropped.png"  # Ruta per guardar la nova textura
